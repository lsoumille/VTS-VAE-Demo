<?php
    ...
    $to_detoken = $_POST['data'];
    //$name = $_POST['name'];
    $template = $_POST['template'];
    
    //The JSON data.
    $jsonData = array( 'tokengroup' => 'VTSDemoGroup', 'token' => $to_detoken, 'tokentemplate' => $template);
    ...
    if (strcmp($obj->status, "Succeed") !== 0)
      ...
      $dbh = new DBHelper();
      $dbh->addData("Detokenization", $to_detoken, $obj->data, $tokentemplate);
