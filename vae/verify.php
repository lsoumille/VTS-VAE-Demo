<?php
    ...
    //The POST data.
    $post_data = http_build_query(array( 'keyname' => $key, 'message' => $to_sign, 'signature' => $signature));
    ...
    curl_setopt_array($tok, array(
        ...
        CURLOPT_URL => $verify_url.$pincode,
        CURLOPT_POST => true,
    ...
    if (isset($obj->message))
      ...
      $dbh = new DBHelper();
      $dbh->addData("Verify", $to_sign."//".$signature, $obj->text, $key);
